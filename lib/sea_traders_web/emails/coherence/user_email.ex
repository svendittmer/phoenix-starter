...
defmodule SeaTradersWeb.Coherence.UserEmail do
  @moduledoc false
  use Phoenix.Swoosh, view: SeaTradersWeb.Coherence.EmailView, layout: {SeaTradersWeb.Coherence.LayoutView, :email}
  alias Swoosh.Email
  require Logger
