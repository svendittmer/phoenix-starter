defmodule SeaTradersWeb.Coherence.ViewHelpers do
  @moduledoc """
  ...
  @seperator {:safe, "&nbsp; | &nbsp;"}
  @helpers SeaTradersWeb.Router.Helpers
  ...
  * :register - customize the register link text (#{@register_link})
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SeaTradersWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SeaTradersWeb.Gettext, "errors", msg, opts)
    end
  end
